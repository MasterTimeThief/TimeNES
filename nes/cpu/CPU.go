...
func Emulate_CPU( /*g *Game*/ ) {
	...
	case 0x24: //BIT Zero Page
		Address := ReadOperands_ZeroPageAddressed()
		Op_BIT(bus.Read(Address))
		CPU_Cycles = 3
	case 0x2C: //BIT Absolute
		ReadOperands_AbsoluteAddressed(false)
		Op_BIT(bus.Read(AddressBus))
		CPU_Cycles = 4
	...
	case 0xE4: //CPX Zero Page
		Address := ReadOperands_ZeroPageAddressed()
		Op_CPX(bus.Read(Address))
		CPU_Cycles = 3
	case 0xEC: //CPX Absolute
		ReadOperands_AbsoluteAddressed(false)
		Op_CPX(bus.Read(AddressBus))
		CPU_Cycles = 4
	...
	case 0xC4: //CPY Zero Page
		Address := ReadOperands_ZeroPageAddressed()
		Op_CPY(bus.Read(Address))
		CPU_Cycles = 3
	case 0xCC: //CPY Absolute
		ReadOperands_AbsoluteAddressed(false)
		Op_CPY(bus.Read(AddressBus))
		CPU_Cycles = 4
	...
	case 0x9B: //TAS (SHS) Absolute, Y
		...
		Push(temp)
		Address := ReadOperands_AbsoluteAddressed_YIndexed(false)
		bus.Write(Address, (A&X)&(byte(Address&0xFF00)+1))
		CPU_Cycles = 5
